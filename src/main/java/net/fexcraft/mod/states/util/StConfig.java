...
public class StConfig {
	...
	//other
	public static int MAP_UPDATES_PER_SECOND, TRANSIT_ZONE_BOTTOM_LIMIT, TRANSIT_ZONE_TOP_LIMIT, CHUNK_PER_CITIZEN, NICKNAME_LENGTH, LOADED_CHUNKS_PER_MUNICIPALITY;
	public static boolean ALLOW_WILDERNESS_ACCESS, ALLOW_TRANSIT_ZONES, SHOW_MINIMAP, STATES_CHAT, ALLOW_MAILBOX_COLLECT, FORGE_ADMIN_CHECK;
	//
