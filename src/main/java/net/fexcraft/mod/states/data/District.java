...
public class District implements ColorHolder, BuyableType, IconHolder, MailReceiver, Ruleable {
	...
	public final Rule r_CLAIM_CHUNK, r_SET_MAILBOX, r_OPEN_MAILBOX;
	...
	public District(int id){
		...
		rules.add(r_SET_CUSTOM_CHUNKTAX = new Rule("set.custom_chunktax", null, true, Initiator.COUNCIL_ANY, Initiator.INCHARGE));
		rules.add(r_CLAIM_CHUNK = new Rule("claim.chunk", null, true, Initiator.COUNCIL_VOTE, Initiator.INCHARGE));
